...
#define SLEW_FLOAT_CALC(v)                                      \
    if ((v.Out - v.In) < 0.0)                                   \
    {                                                           \
        if ((-(v.Out - v.In)) > v.Slope_up * v.Sampling_period) \
            v.Out = v.Out + v.Slope_up * v.Sampling_period;     \
        else                                                    \
            v.Out = v.In;                                       \
    }                                                           \
    if ((v.Out - v.In) > 0.0)                                   \
    {                                                           \
        if ((v.Out - v.In) > v.Slope_down * v.Sampling_period)  \
            v.Out = v.Out - v.Slope_down * v.Sampling_period;   \
        else                                                    \
            v.Out = v.In;                                       \
    }                                                           \
